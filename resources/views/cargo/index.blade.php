        ...
        <div class="card-body">
            <table id="datatablesSimple" class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                ...
                                @endcan
                                @can('eliminar-cargo')
                                <button type="button" class="btn btn-danger rounded" data-bs-toggle="modal" data-bs-target="#deleteModal-{{$cargo->id}}"><i class="fa-solid fa-trash"></i></button>
                                @endcan
                    ...
                    <!-- Modal Eliminar-->
                    <div class="modal fade" id="deleteModal-{{$cargo->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Seguro que quieres eliminar este Cargo?
                                </div>
