        ...
        <div class="card-body">
            <table id="datatablesSimple" class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                <button type="button" class="btn btn-success rounded " data-bs-toggle="modal" data-bs-target="#verModal-{{$etapa->id}}"><i class="fa-solid fa-eye"></i></button>
                                @can('editar-etapa')
                                ...
                                @endcan
                                @can('desabilizar-etapa')
                                @if ($etapa->state == 1)
                                <button type="button" class="btn btn-warning rounded" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$etapa->id}}"><i class="fa-solid fa-toggle-off fa-xl rounded"></i></button>
                                @else
                                <button type="button" class="btn btn-info rounded" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$etapa->id}}"><i class="fa-solid fa-toggle-on fa-xl"></i></button>
                                @endif
                                @endcan
                                @can('eliminar-etapa')
                                <button type="button" class="btn btn-danger rounded" data-bs-toggle="modal" data-bs-target="#deleteModal-{{$etapa->id}}"><i class="fa-solid fa-trash"></i></button>
                                @endcan
                    ...
                    <!-- Modal Eliminar-->
                    <div class="modal fade" id="deleteModal-{{$etapa->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input disabled type="text" class="form-control bg-white" value="{{$etapa->name}}">
                                    </div>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text"><i class="fa-solid fa-people-group"></i></span>
                                        <input disabled type="text" class="form-control" value="Descripcion:">
                                        <input disabled type="text" class="form-control bg-white" value="{{$etapa->description}}">
                                    </div>
                                    <div class="input-group mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <span class="input-group-text"><i class="fa-solid fa-people-group"></i></span>
                                        <input disabled type="text" class="form-control" value="Descripcion:">
                                        <input disabled type="text" class="form-control bg-white" value="{{$etapa->leagueExecutive->name}}">
                                    </div>
                                    <div class="mt-2">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{route('etapas.destroy', ['etapa' => $etapa->id])}}" method="post">
                                        @method('DELETE')
                                        @csrf
                                        <button type="submit" class="btn {{$etapa->state == 1 ? 'btn-warning' : 'btn-info'}}">
