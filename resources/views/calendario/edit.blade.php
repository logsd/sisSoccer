                        ...
                        <div >
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="text" name="stadium" id="stadium" class="form-control"
                                    value="{{old('stadium',$calendario->stadium)}}">
                                @error('stadium')
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="observation" id="observation" rows="3"
                                    class="form-control">{{old('observation',$calendario->observation)}}</textarea>
                                @error('observation')
                                <small class="text-danger">{{'*'.$message}}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="referee" id="referee" class="form-control"
                                    value="{{old('referee',$calendario->referee)}}">
                                @error('referee')
                                <small class="text-danger">{{'*'.$message}}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-2 ">
                                ...
                                <input type="text" name="vocal" id="vocal" class="form-control"
                                    value="{{old('vocal',$calendario->vocal)}}">
                                @error('vocal')
                                <small class="text-danger">{{'*'.$message}}</small>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select data-size="3" title="Seleccione un Equipo" data-live-search="true"
                                    name="team_home_id" id="team_home_id" class="form-control selectpicker show-tick">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select data-size="3" title="Seleccione un Equipo" data-live-search="true"
                                    name="team_away_id" id="team_away_id" class="form-control selectpicker show-tick">
                                    @foreach ($equipos as $item)
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="date" name="date" id="date" class="form-control border-success"
                                        value="{{old('date', $calendario->date)}}">
                                    @error('date')
                                        <small class="text-danger">{{'*' . $message}}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="time" name="time" id="time" class="form-control border-success"
                                        value="{{ old('time', $calendario->time) }}">
                                    @error('time')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
...
>>>>>>> 90b7595c7272dd63a34f72ab37a566ae98faca77
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <select data-size="3" title="Seleccione un Estado" data-live-search="true"
                                            name="status" id="status" class="form-control selectpicker show-tick">
