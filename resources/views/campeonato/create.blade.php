                        ...
                        <div class="p-3 border border-3 border-success">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="date" name="start_date" id="start_date" class="form-control border-success" value="{{old('start_date')}}">
                                    @error('start_date')
                                    <small class="text-danger">{{'*'.$message}}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="date" name="end_date" id="end_date" class="form-control border-success" value="{{old('end_date')}}">
                                    @error('end_date')
                                    <small class="text-danger">{{'*'.$message}}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="date" name="from" id="from" class="form-control border-success" value="{{old('from')}}">
                                    @error('from')
                                    <small class="text-danger">{{'*'.$message}}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="date" name="until" id="until" class="form-control border-success" value="{{old('until')}}">
                                    @error('until')
                                    <small class="text-danger">{{'*'.$message}}</small>
                                    @enderror
                                </div>
