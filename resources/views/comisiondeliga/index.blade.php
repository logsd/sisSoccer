    ...
    <div class="card-body">
      <table id="datatablesSimple" class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                <button type="button" class="btn btn-success rounded" data-bs-toggle="modal" data-bs-target="#verModal-{{$comisiondeliga->id}}"><i class="fa-solid fa-eye"></i></button>
                @can('editar-comision')
                ...
                @endif
                @endcan
                @can('eliminar-comision')
                <button type="button" class="btn btn-danger rounded" data-bs-toggle="modal" data-bs-target="#deleteModal-{{$comisiondeliga->id}}"><i class="fa-solid fa-trash"></i></button>
                @endcan
              </div>
            </td>
          ...
          <!-- Modal Eliminar-->
          <div class="modal fade" id="deleteModal-{{$comisiondeliga->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  Seguro que quieres eliminar esta Comisión?
                </div>
        ...
        <div class="modal-content bg-white">
          ...
          <div class="modal-footer">
            ...
            <form action="{{route('comisiondeligas.destroy',['comisiondeliga'=>$comisiondeliga])}}" method="post">
              @method('DELETE')
              @csrf
              <button type="submit" class="btn {{$comisiondeliga->state == 1 ? 'btn-warning' : 'btn-info'}}">
