...
<div class="container-fluid px-4">
  ...
  <div class="mb-4">
    <a href="{{route('categorias.create')}}">
      <button type="button" class="btn btn-primary">Añadir nuevo Categoria</button>
    </a>
  </div>
  <div class="card mb-4">
          ...
          <tr>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                ...
                @if ($categoria->state == 1)
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$categoria->id}}">Desabilitar</button>
                @else
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  {{$categoria->state ==1 ? 'Seguro que quieres eliminar esta Categoria?' : 'Seguro que quieres restaurar esta Categoria?'}}
                </div>
