...
<div class="container-fluid px-4">
                        ...
                        <a href="{{route('carnets.create')}}">
                            <button type="button" class="btn btn-primary">Añadir nuevo Carnet</button>
                        </a>
                        </div>
                        <div class="card mb-4">
                                ...
                                <table id="datatablesSimple" class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($carnets as $carnet )
                                            <tr>
                                                <td>
                                                <p class="fw-semibold mb-1"> {{$carnet->cod}} </p>
                                                </td>
                                                <td>
                                                    {{$carnet->player->name?? ''}}
                                                </td>
                                                <td>
                                                    {{$carnet->championship->name?? ''}}
                                                </td>
                                                <td>
                                                    @if ($carnet->state == 1)
                                                ...
                                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                    ...
                                                    @endif
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal-{{$carnet->id}}">Eliminar</button>
...
<!-- Modal Eliminar-->
<div class="modal fade" id="deleteModal-{{$carnet->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Mensaje de Confirmación</h1>
                                ...
                                <div class="modal-body">
                                    Seguro que quieres eliminar este carnet?
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
