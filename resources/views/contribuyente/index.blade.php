                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                ...
                                @if ($contribuyente->state == 1)
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$contribuyente->id}}">Desabilitar</button>
                                @else
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{$contribuyente->state ==1 ? 'Seguro que quieres desabilitar este Contribuyente?' : 'Seguro que quieres restaurar este Contribuyente?'}}
                                </div>
