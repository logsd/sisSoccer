...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb my-4">
        ...
        <li class="breadcrumb-item active">Actualizar Cargo</li>
    </ol>
    <h1 class="my-4 text-center ">Actualizar Cargo</h1>
<div class="cuerpo">
        <form action="{{route('cargos.update', ['cargo' => $cargo])}}" method="post">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="f_start" id="f_start" class="form-control"
                        value="{{old('f_start', $cargo->f_start)}}">
                    @error('f_start')
                        <small class="text-danger">{{'*' . $message}}</small>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="f_end" id="f_end" class="form-control"
                        value="{{old('f_end', $cargo->f_end)}}">
                    @error('f_end')
                        <small class="text-danger">{{'*' . $message}}</small>
                    @enderror
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <textarea name="observation" id="observation" rows="3"
                        class="form-control">{{old('observation', $cargo->observation)}}</textarea>
                    @error('observation')
                        <small class="text-danger">{{'*' . $message}}</small>
                    @enderror
                </div>
