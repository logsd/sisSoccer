    ...
    <div class="card-body">
      <table id="datatablesSimple" class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                ...
                @endif
                @endcan
                @can('eliminar-cargoOficina')
                <button type="button" class="btn btn-danger rounded" data-bs-toggle="modal" data-bs-target="#deleteModal-{{$cargooficina->id}}"><i class="fa-solid fa-trash"></i></button>
                @endcan
              </div>
            </td>
          ...
          <!-- Modal Eliminar-->
          <div class="modal fade" id="deleteModal-{{$cargooficina->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  Seguro que quieres eliminar este Cargo de Oficina?
                </div>
