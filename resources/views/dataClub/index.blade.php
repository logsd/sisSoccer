        ...
        <div class="card-body">
            <table id="datatablesSimple" class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                ...
                                @endcan
                                @can('desabilizar-club')
                                @if ($club->state == 1)
                                <button type="button" class="btn btn-warning rounded" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$club->id}}"><i class="fa-solid fa-toggle-off fa-xl"></i></button>
                                @else
                                <button type="button" class="btn btn-info rounded" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$club->id}}"><i class="fa-solid fa-toggle-on fa-xl"></i></button>
                                @endif
                                @endcan
                                @can('eliminar-club')
                                <button type="button" class="btn btn-danger rounded" data-bs-toggle="modal" data-bs-target="#deleteModal-{{$club->id}}"><i class="fa-solid fa-trash"></i></button>
                                @endcan
                    ...
                    <!-- Modal Eliminar Club-->
                    <div class="modal fade" id="deleteModal-{{$club->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{route('clubs.destroy', ['club' => $club->id])}}" method="post">
                                        @method('DELETE')
                                        @csrf
                                        <button type="submit" class="btn {{$club->state == 1 ? 'btn-warning' : 'btn-info'}}">
        ...
        <div class="card-body">
            <table id="datatablesSimple1" class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                ...
                                @endcan
                                @can('desabilizar-dataClub')
                                @if ($dataClub->state == 1)
                                <button type="button" class="btn btn-warning rounded" data-bs-toggle="modal" data-bs-target="#confirmModal1-{{$dataClub->id}}"><i class="fa-solid fa-toggle-off fa-xl"></i></button>
                                @else
                                <button type="button" class="btn btn-info rounded" data-bs-toggle="modal" data-bs-target="#confirmModal1-{{$dataClub->id}}"><i class="fa-solid fa-toggle-on fa-xl"></i></button>
                                @endif
                                @endcan
                                @can('eliminar-dataClub')
                                <button type="button" class="btn btn-danger rounded" data-bs-toggle="modal" data-bs-target="#deleteModal1-{{$dataClub->id}}"><i class="fa-solid fa-trash"></i></button>
                                @endcan
                    ...
                    <!-- Modal Eliminar-->
                    <div class="modal fade" id="deleteModal1-{{$dataClub->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Mensaje de Confirmación</h1>
                    ...
                    <!-- Modal Eliminar -->
                    <div class="modal fade" id="confirmModal1-{{$dataClub->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Mensaje de Confirmación</h1>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{route('dataClubs.destroy', ['dataClub' => $dataClub->id])}}" method="post">
                                        @method('DELETE')
                                        @csrf
                                        <button type="submit" class="btn {{$dataClub->state == 1 ? 'btn-warning' : 'btn-info'}}">
